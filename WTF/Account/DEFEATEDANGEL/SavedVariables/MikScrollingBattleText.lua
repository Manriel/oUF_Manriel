		...
		["Default"] = {
			...
			["triggers"] = {
				["MSBT_TRIGGER_OVERPOWER"] = {
					["exceptions"] = "unavailableSkill;;eq;;Превосходство;;warriorStance;;eq;;1",
				},
				["MSBT_TRIGGER_LOW_HEALTH"] = {
					["mainEvents"] = "UNIT_HEALTH{unitID;;eq;;player;;threshold;;lt;;20}",
					["iconSkill"] = "3273",
				},
				...
				["MSBT_TRIGGER_EXECUTE"] = {
					["exceptions"] = "unavailableSkill;;eq;;Казнь;;warriorStance;;eq;;1",
				},
			},
			["damageThreshold"] = 500,
			["holy"] = {
			...
			["events"] = {
				...
				["PET_OUTGOING_SPELL_ABSORB"] = {
					["message"] = "Питомец поглощение",
					["scrollArea"] = "Custom2",
				},
				["PET_INCOMING_DEFLECT"] = {
					["message"] = "Питомец отклонение!",
				},
				["INCOMING_SPELL_MISS"] = {
					["message"] = "(%s) Промах",
					["colorR"] = 0.4,
			...
			["critFontName"] = "San Francisco (Heavy)",
			["enableBlizzardDamage"] = false,
			["normalFontName"] = "San Francisco (Regular)",
			["healThreshold"] = 500,
			["normalFontSize"] = 16,
		},
		["Manriel UI Heal"] = {
