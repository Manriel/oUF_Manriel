...
--	configuration options > system
	...
	L["CONFIG_SYSTEM_WORKAROUND_THREAD"] = "Threads (co-routines)"
	L["CONFIG_SYSTEM_WORKAROUND_THREAD_DEBUG_TEXT"] = "toggle thread debug output\n\nNote: Don't turn this on unless you have a very good reason to do so."
	L["CONFIG_SYSTEM_WORKAROUND_THREAD_DISABLED_TEXT"] = "toggle the use of threads (co-routines) - these stop you from getting \"script ran too long\" errors.\n\nNote: Don't turn this off unless you have a very good reason to do so.\n\nThis is a per session variable and will revert back to Enabled at every UI Reload"
	L["CONFIG_SYSTEM_WORKAROUND_THREAD_TIMEOUT"] = "Timeout (ms)"
	L["CONFIG_SYSTEM_WORKAROUND_THREAD_TIMEOUT_NORMAL"] = "Out of Combat"
	L["CONFIG_SYSTEM_WORKAROUND_THREAD_TIMEOUT_NORMAL_TEXT"] = "the number of milliseconds before the code will yield when out of combat"
	L["CONFIG_SYSTEM_WORKAROUND_THREAD_TIMEOUT_COMBAT"] = "In Combat"
	L["CONFIG_SYSTEM_WORKAROUND_THREAD_TIMEOUT_COMBAT_TEXT"] = "the number of milliseconds before the code will yield when in combat"
