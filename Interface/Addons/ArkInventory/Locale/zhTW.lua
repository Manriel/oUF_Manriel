...
--	L["CONFIG_SYSTEM_TOOLTIP_BATTLEPET_MOUSEOVER_ENABLE_TEXT"] = ""
	...
	L["CONFIG_SYSTEM_WORKAROUND"] = "除錯/規避錯誤"
	L["CONFIG_SYSTEM_WORKAROUND_TEXT"] = "切換除錯或規避錯誤的程式碼"
	L["CONFIG_SYSTEM_WORKAROUND_FRAMELEVEL"] = "框架層級"
	L["CONFIG_SYSTEM_WORKAROUND_FRAMELEVEL_TEXT"] = "暴風雪的CreateFrame API有個bug會導致框架背景蓋住前景，使物品提示無法顯示，也不能點擊視窗裡的任何東西。"
	L["CONFIG_SYSTEM_WORKAROUND_FRAMELEVEL_ALERT_TEXT"] = "設定框架層級除錯警告的顯示方式"
	L["CONFIG_SYSTEM_WORKAROUND_FRAMELEVEL_ALERT_STYLE0"] = "不顯示"
	L["CONFIG_SYSTEM_WORKAROUND_FRAMELEVEL_ALERT_STYLE0_TEXT"] = "不顯示除錯警告"
	L["CONFIG_SYSTEM_WORKAROUND_FRAMELEVEL_ALERT_STYLE1"] = "簡短"
	L["CONFIG_SYSTEM_WORKAROUND_FRAMELEVEL_ALERT_STYLE1_TEXT"] = "顯示簡短的除錯警告"
	L["CONFIG_SYSTEM_WORKAROUND_FRAMELEVEL_ALERT_STYLE2"] = "完整"
	L["CONFIG_SYSTEM_WORKAROUND_FRAMELEVEL_ALERT_STYLE2_TEXT"] = "顯示完整的除錯警告"
