---------------------------------------------------- Backdrop
local backdrop = {	
	bgFile = "interface\\AddOns\\aPanels\\media\\halback",
	edgeFile = "interface\\AddOns\\aPanels\\media\\border32",
	edgeSize = 32,
...
GameTooltip_SetDefaultAnchor = function(self, parent)
	...
	self:SetPoint("TOPLEFT", UIParent, "TOPLEFT", 3, -30)
...
local OnTooltipSetUnit = function(self)
    ...
    if(UnitExists(unit.."target") and unit~="player") then
        ...
        if(UnitName(unit.."target")==UnitName("player")) then
            ...
            text = "Цель: "..UnitName(unit.."target")
        end
